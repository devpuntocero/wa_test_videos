...
{
    public partial class ctrl_transformar : System.Web.UI.Page
    {
        ...
        {
            rb_transformation.Checked = false;
            div_transformation.Visible = false;
        }

        protected void rb_transformation_CheckedChanged(object sender, EventArgs e)
        {
        ...
        protected void cmd_search_Click(object sender, EventArgs e)
        {
            ...
            lbl_mnsj.Text = "";
            int str_idload;
            if (rb_active.Checked || rb_transformation.Checked)
            {
                ...
                else if (rb_transformation.Checked)
                {
                    str_idload = 3;
                    filter_videos(str_idload);
