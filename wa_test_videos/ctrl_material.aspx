<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ctrl_material.aspx.cs" Inherits="wa_test_videos.ctrl_material" %>
            ...
            <div class="container">
                ...
                <div class="row animated bounceInUp">
                      <div class="col-md-4 text-center" id="div_videos_load" runat="server">
                        <h5>Subir</h5>
                        <asp:ImageButton ID="img_videos_load" runat="server" ImageUrl="~/images/iconos/videos@2x.png"  OnClick="img_videos_load_Click"  />
                    </div>
                    <div class="col-md-4 text-center" id="div_transformation" runat="server">
                        <h5>Transformar</h5>
                        <asp:ImageButton ID="img_transformation" runat="server" ImageUrl="~/images/iconos/herramientas@2x.png" OnClick="img_transformation_Click"  />
                    </div>
                    <div class="col-md-4 text-center" id="div_configuration" runat="server">
                        <h5>Configuración</h5>
                        <asp:ImageButton ID="img_configuration" runat="server" ImageUrl="~/images/iconos/control de centros@2x.png" OnClick="img_configuration_Click"   />
                    </div>
                </div>
            </div>
        </div>
